...
public class AuthController {
    ...
    @PostMapping("/login")
    public ResponseEntity<String> login(@RequestBody SignInRequest userDto) {
        if (userDto.getUsername() == null || userDto.getUsername().isEmpty())
            return new ResponseEntity<>("Username is required", HttpStatus.NOT_ACCEPTABLE);
        else if (!userService.existsByUsername(userDto.getUsername()))
            return new ResponseEntity<>("User with this username not found", HttpStatus.NOT_ACCEPTABLE);
    ...
    public ResponseEntity<String> register(@RequestBody RegisterDto userDto) {
        ...
        if (userDto.getSurname() == null || userDto.getSurname().isEmpty())
            return new ResponseEntity<>("Surname is required", HttpStatus.NOT_ACCEPTABLE);
        ...
        if (userDto.getEmail() == null || userDto.getEmail().isEmpty())
            ...
            return new ResponseEntity<>("Wrong email format", HttpStatus.NOT_ACCEPTABLE);
